...
const decorateOrder = (order, tokens) => {
	...
	// Example: Give mETH in exchange for DApp
	...
	// Calculate token prices to 5 decimal places
...
export const filledOrdersSelector = createSelector(
	...
	(orders, tokens) => {
		...
		// [x] Step 1: sort orders by time acending
		// [x] Step 2: apply order colors (decorate orders)
		// Step 3: sort orders by time decending for UI

		// Step 1: sort orders by time acending for price comparison
...
export const orderBookSelector = createSelector(
	...
	orders = {
		...orders,
		sellOrders: sellOrders.sort((a, b) => b.token - a.tokenPrice)
	}
...
export const priceChartSelector = createSelector(
	...
	(orders, tokens) => {
		...
		// Sort orders by date acending to compare history
		orders = orders.sort((a, b) => a.timestamp - b.timestamp)
